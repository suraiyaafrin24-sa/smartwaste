...
<head>
    ...
    <title>Duty Roster - SmartBin Admin</title>
    <!-- Google Fonts -->
...
<body class="bg-slate-50 text-slate-800 min-h-screen flex flex-col justify-between">
    ...
    <main class="flex-grow max-w-4xl w-full mx-auto px-4 py-8 space-y-6">
        <h2 class="text-3xl font-black text-slate-900 border-b pb-4">Duty Roster Console</h2>
        <div class="bg-white border rounded-3xl p-8 shadow-sm text-center py-16 space-y-4">
            ...
            <p class="text-slate-500 text-sm max-w-sm mx-auto">Create weekly routes schedules for waste zoning systems
                in Uttara.</p>
        </div>
    </main>
