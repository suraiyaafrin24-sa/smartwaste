...
<head>
    ...
    <title>Payment Collection - SmartBin Collector</title>
    <!-- Google Fonts -->
...
<body class="bg-slate-50 text-slate-808 min-h-screen flex flex-col justify-between">
    ...
    <main class="flex-grow max-w-4xl w-full mx-auto px-4 py-8 space-y-6">
        <h2 class="text-3xl font-black text-slate-900 border-b pb-4">Cash / Plan Payment Log</h2>
        <div class="bg-white border rounded-3xl p-8 shadow-sm text-center py-16 space-y-4">
            <div
                ...
                <i data-lucide="dollar-sign" class="w-8 h-8"></i></div>
            <h3 class="text-xl font-bold text-slate-905">Collect Bill Payment</h3>
            <p class="text-slate-500 text-sm max-w-sm mx-auto">Track dynamic hand-to-hand billing payments, subscription
                details and log receipt updates.</p>
        </div>
    </main>
