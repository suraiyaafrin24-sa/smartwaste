...
<head>
    ...
    <title>Complaints - SmartBin Admin</title>
    <!-- Google Fonts -->
...
<body class="bg-slate-50 text-slate-800 min-h-screen flex flex-col justify-between">
    ...
    <main class="flex-grow max-w-4xl w-full mx-auto px-4 py-8 space-y-6">
        <h2 class="text-3xl font-black text-slate-900 border-b pb-4">Complaints Board</h2>
        <div class="bg-white border rounded-3xl p-8 shadow-sm text-center py-16 space-y-4">
            <div class="w-16 h-16 rounded-full bg-rose-100 text-rose-600 flex items-center justify-center mx-auto"><i
                    data-lucide="alert-triangle" class="w-8 h-8"></i></div>
            <h3 class="text-xl font-bold text-slate-905">Review client complaints</h3>
            <p class="text-slate-500 text-sm max-w-sm mx-auto">Manage complaints submitted by residents regarding
                missing pickups or collector issues.</p>
        </div>
    </main>
