...
<head>
    ...
    <title>Profile Settings - SmartBin Collector</title>
    <!-- Google Fonts -->
...
<body class="bg-slate-50 text-slate-808 min-h-screen flex flex-col justify-between">
    <header class="bg-emerald-950 text-white sticky top-0 z-40">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex justify-between items-center h-16">
            <div class="flex items-center space-x-8">
                <a href="/" class="flex items-center space-x- group">
                    <div
    ...
    <main class="flex-grow max-w-4xl w-full mx-auto px-4 py-8 space-y-6">
        <h2 class="text-3xl font-black text-slate-900 border-b pb-4">Profile & Crew Profile Settings</h2>
        <div class="bg-white border rounded-3xl p-8 shadow-sm text-center py-16 space-y-4">
            <div
                ...
                <i data-lucide="settings" class="w-8 h-8"></i></div>
            <h3 class="text-xl font-bold text-slate-905">Collector Profile</h3>
            <p class="text-slate-500 text-sm max-w-sm mx-auto">Update your dashboard credentials, edit phone numbers,
                and change access passwords.</p>
        </div>
    </main>
