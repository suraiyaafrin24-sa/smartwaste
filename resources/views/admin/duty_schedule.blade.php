...
<head>
    ...
    <title>Duty Schedule - SmartBin Admin</title>
    <!-- Google Fonts -->
...
<body class="bg-slate-50 text-slate-805 min-h-screen flex flex-col justify-between">
    ...
    <main class="flex-grow max-w-4xl w-full mx-auto px-4 py-8 space-y-6">
        <h2 class="text-3xl font-black text-slate-900 border-b pb-4">Duty Schedule Logs</h2>
        <div class="bg-white border rounded-3xl p-8 shadow-sm text-center py-16 space-y-4">
            <div class="w-16 h-16 rounded-full bg-indigo-100 text-indigo-600 flex items-center justify-center mx-auto">
                <i data-lucide="clock" class="w-8 h-8"></i></div>
            <h3 class="text-xl font-bold text-slate-905">System Duty Timeline Listings</h3>
            <p class="text-slate-500 text-sm max-w-sm mx-auto">Reference weekly shift rotations and service parameters
                for Uttara zoning sectors.</p>
        </div>
    </main>
